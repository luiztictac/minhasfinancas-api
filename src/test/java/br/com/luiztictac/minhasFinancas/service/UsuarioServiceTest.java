...
import br.com.luiztictac.minhasFinancas.service.impl.UsuarioServiceImpl;
...
public class UsuarioServiceTest {
	...
	public void deveLancarErroQuandoSenhaNaoBater() {
		...
		Assertions.assertThat(exception).isInstanceOf(ErroAutenticacao.class).hasMessage("Senha ou e-mail inválidos!!");
